...
// Standard ERC-20 surface needed to approve/read USDC for the Fund feature.
...
// Standard ERC-4626 vault surface (deposit/withdraw/redeem + reads). This is
// the EXISTING Moonwell/Morpho vault's own interface — we deploy nothing.
